...
import (
	"github.com/lingyao2333/mo-zero/tools/goctl/api/apigen"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/dartgen"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/docgen"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/format"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/gogen"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/javagen"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/ktgen"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/new"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/tsgen"
	"github.com/lingyao2333/mo-zero/tools/goctl/api/validate"
...
func init() {
	...
	Cmd.Flags().StringVar(&apigen.VarStringRemote, "remote", "", "The remote git repo of the"+
		...
		" https://github.com/lingyao2333/mo-zero-template directory structure")
	...
	goCmd.Flags().StringVar(&gogen.VarStringStyle, "style", "gozero", "The file naming format,"+
		" see [https://github.com/lingyao2333/mo-zero/blob/master/tools/goctl/config/readme.md]")
	...
	pluginCmd.Flags().StringVar(&plugin.VarStringStyle, "style", "",
		"The file naming format, see [https://github.com/lingyao2333/mo-zero/tree/master/tools/goctl/config/readme.md]")
